        ...
        >
          ...
          <div>
            ...
            <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white">
              Guardian | Xoloti Realms
            </p>
          </div>

          <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
            “The magic of Xoloti's world connects us all. Its endless potential
            fosters not just exploration but also a deeper connection to the
            metaverse and Web3 realms.”
          </p>
        </motion.div>
        <motion.div
